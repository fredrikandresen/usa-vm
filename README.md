...
- Signup endpoint with company selection and Supabase magic-link/Entra-ready auth metadata
...
- Supabase/Postgres schema + seeds (companies and 48 teams across 12 groups)
